...
function guideCard() {
  ...
  g.innerHTML = `
    ...
    <p class="lead">Each entry is one research idea. Some are real papers, some were
      generated by a model — there is no answer key.</p>

    <div class="g"><span class="n">What to read</span><span class="t">
      Review from the <b>title and abstract</b>. The <b>Structured summary</b> under them
      is extracted automatically by an LLM and is only a reading aid — where it disagrees
      with the abstract, the abstract wins.</span></div>

    <div class="g"><span class="n">Block 1</span><span class="t">
      <b>Review dimensions</b> — Soundness, Presentation, Contribution, each 1–4.
      Definitions follow the ICLR 2026 official review form; apply them as you would
      when reviewing a submission.</span></div>

    <div class="g"><span class="n">Block 2</span><span class="t">
      <b>Can it be done · will it work</b> — no rubric here; answer from your own
      research experience. <b>Feasibility</b> is whether the study could actually be
      carried out; <b>Expected success</b> is whether the main claim would hold if it
      were. Keep the two apart: easy-to-run ideas that are unlikely to work are
      common.</span></div>

    <div class="g"><span class="n">Block 3</span><span class="t">
      <b>Overall</b> — your accept/reject verdict on a six-point scale, how confident
      you are in it, and one blinding check: whether you think this entry is a real
